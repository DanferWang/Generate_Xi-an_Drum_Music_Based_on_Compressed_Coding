...
inputDir = '../'
fileName = inputDir + 'original_dataset.txt'  # datasetName
### output initalize
rePut1 = []
rePut2 = []
rePut3 = []
...
## encoder
encoder_input = Input(shape=(n_steps,3,), name="encoder_input")
...
encoder.summary()
plot_model(encoder, to_file="VAE_TUL_encoder_plot.png", show_shapes=True, show_layer_names=True)
...
decoder_output = Dense(1, activation="relu", name="decoder_output")(lstmT_2)

### decoder model
decoder = Model(decoder_input, decoder_output, name="decoder")
decoder.summary()
plot_model(decoder, to_file="VAE_TUL_decoder_plot.png", show_shapes=True, show_layer_names=True)

## VAE
vae_output = decoder(encoder(encoder_input)[2])
vae = Model(encoder_input, vae_output, name="VAE")
vae.summary()
plot_model(decoder, to_file="VAE_TUL_plot.png", show_shapes=True, show_layer_names=True)
...
vae.compile(optimizer="adam", loss=kl_divergence_loss)
